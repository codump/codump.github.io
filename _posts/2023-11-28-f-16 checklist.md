...
<button class="blueButton" onclick="window.open('https://codump.github.io/demo/codump.github.io/tree/gh-pages/f16/')">Demo</button> <button class="greenButton" onclick="window.open('https://github.com/codump/codump.github.io/tree/gh-pages/f16/')">See code</button>
